...
export default function SupplyTransferTab() {
            ...
            >
              ...
              >
                <div style={{ flex: 1 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                    <div style={{ fontSize: 17, fontWeight: 600, color: state.selectedStore ? md3.onPrimaryContainer : md3.onSurface }}>
                      {supply.name}
                    </div>
                    <div
                      style={{
                  ...
                  <div style={{ fontSize: 13, color: state.selectedStore ? md3.onPrimaryContainer : md3.onSurfaceVariant, marginTop: 4 }}>
              ...
              {state.selectedStore && (() => {
                ...
                return (
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                      <span style={{ fontSize: 14, fontWeight: 500, color: isOverStock ? md3.onErrorContainer : md3.onPrimaryContainer }}>
                      ...
                      <MD3QuantityStepper
                        ...
                        size="small"
                      />
                      <span style={{ fontSize: 16, fontWeight: 600, color: isOverStock ? md3.onErrorContainer : md3.onPrimaryContainer }}>
                        ¥{((supply.unit_price || 0) * state.quantity).toLocaleString()}
                      </span>
                      {isOverStock && (
                        <span style={{ fontSize: 13, fontWeight: 600, color: md3.error, display: "flex", alignItems: "center", gap: 4 }}>
              ...
              {recentTransfers.length > 0 && (
                <div style={{ padding: "8px 20px 12px", borderTop: `1px solid ${md3.outlineVariant}`, display: "flex", gap: 12, flexWrap: "wrap" }}>
                  {recentTransfers.map((t) => (
                    <span key={t.id} style={{ fontSize: 12, color: md3.onSurfaceVariant }}>
                    ...
                    return (
                      <MD3TableRow hoverable={false}>
                        <MD3TableCell colSpan={3}>
                          <div style={{ textAlign: "center", padding: "24px 16px", color: md3.onSurfaceVariant }}>データなし</div>
                        </MD3TableCell>
                      </MD3TableRow>
                    )
                  }
                ...
                {transfers.length === 0 ? (
                  <MD3TableRow hoverable={false}>
                    <MD3TableCell colSpan={4}>
                      <div style={{ textAlign: "center", padding: "24px 16px", color: md3.onSurfaceVariant }}>履歴なし</div>
                    </MD3TableCell>
                  </MD3TableRow>
                ) : (
